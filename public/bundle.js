...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        'You can contact or follow me via any of these services:'
	      ),
	      React.createElement(
	        'ul',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('img', { src: this.props.data.path, alt: 'loading...', className: 'img-rounded' })
	      ),
	      React.createElement(
	        'p',
	        { className: 'desc' },
	...
	var Parent = React.createClass({
	  ...
	  clickHandler: function clickHandler(idx) {
	  ...
	  render: function render() {
	    ...
	    var items = this.props.data.map(function (item, idx) {
	      var isSelected = this.state.selectedItem === idx;
	    ...
	    return React.createElement(
	      'ul',
	      { style: ulStyle, className: 'items list-unstyled text-center' },
	      items
	    );
	  }
	});
